...
<body class="font-sans text-gray-800 bg-white">
    <!-- Navbar minimalista no estilo do exemplo -->
    <header class="fixed w-full bg-white shadow-sm z-50">
        <div class="container mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
            <a class="flex items-center" href="#">
                <img src="/img/logo-sre.png" alt="SRE Logo" class="h-10 w-auto">
    ...
    <!-- Hero Section no estilo da imagem exemplo -->
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div class="md:w-1/2">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        <a href="{{ route('login') }}" class="bg-primary hover:bg-secondary text-white font-medium px-6 py-3 rounded-md shadow transition-colors inline-flex items-center">
                            Acessar Sistema
                ...
                <div class="md:w-1/2 flex items-center justify-center">
                    <img src="/img/estudante.png" alt="Imagem do Estudante" class="w-full max-w-lg rounded-xl  transform hover:scale-105 transition-all duration-300">
                </div>
            </div>
    </section>
    ...
    <section class="py-20">
        <div class="container mx-auto px-4 md:px-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold mb-4">Pronto para simplificar seus requerimentos?</h2>
