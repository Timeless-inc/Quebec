...
class ProfessorReportController extends Controller
{
    ...
    public function generateProcessedReport(Request $request)
    {
        ...
        $data = $this->getProfessorData($user, $startDate, $endDate);
        ...
        return $pdf->download('relatorio-professor-processados-' . now()->format('dmY-His') . '.pdf');
    }
    ...
    public function generatePeriodReport(Request $request)
    {
        ...
        return $pdf->download('relatorio-professor-periodo-' . now()->format('dmY-His') . '.pdf');
    }
    ...
    private function getProfessorData($user, $startDate, $endDate)
    {
        $data = [];

        // Requerimentos recebidos (encaminhados para o professor)
